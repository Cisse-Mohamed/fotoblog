...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-lnei45wp+a^c5@#6+h3dop5a+kqo_rezb(kwzmbb_0pz0cnx+3')
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'comptes.validators.ValidateNoSpace',
    },
]
...
LOGOUT_REDIRECT_URL = 'comptes:logout'
